...
describe('10 - Implemente a função `createMenu`, bem como seus casos de teste', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof objetoRetornado1).toBe('object');
    expect(Object.keys(objetoRetornado1)[0]).toEqual('fetchMenu');
    expect(typeof objetoRetornado1.fetchMenu).toBe('function');
    // ```
    ...
    expect(objetoRetornado3.fetchMenu()).toEqual(objetoQualquer);
    // ```
